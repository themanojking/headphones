...
function Home() {
  ...
  return (
    <>
      <Navbar />
      <div className="p-10">
        <div className="flex flex-wrap lg:flex-nowrap justify-center gap-10  lg:py-20 ">
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center gap-10 mt-20">
          <div className="bg-blue-300 rounded-xl">
            <div className="text-center p-10 space-y-1">
              <h1 className=" text-2xl md:text-4xl font-bold">Playing Joystick</h1>
          ...
          <div className="bg-pink-200 rounded-xl ">
            <div className="text-center p-10 space-y-1">
              ...
              <h3 className="text-lg font-semibold">
                Smartwatches connect you to notifications and health tracking all on your wrist.
              </h3>
              <div className="flex items-center justify-center gap-2 text-xl font-bold hover:text-red-500">
                <h3>View Product</h3>
                <FaArrowRight />
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center mt-20 lg:gap-20">
           <div className="lg:py-20 lg:ml-10 space-y-3 ">
              ...
              <h3 className="text-xl md:text-2xl font-semibold">Popular accessories blend elegant design with robust health and connectivity features.</h3>
              <button className="px-3 py-2 bg-red-600 rounded-lg text-white font-bold hover:bg-black">Shop Now</button>
           </div>
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center lg:gap-20 py-20">
           <div className="lg:px-10 space-y-2 py-5">
              <h1 className="text-xl md:text-5xl font-bold">Subscribe to our email and get 25% off</h1>
              <h3 className="text-lg md:text-xl font-semibold">Subscription offers provide recurring access to products or services through regular payments.
              They often include exclusive perks or savings compared to one-time purchases</h3>
              ...
              <div className="space-y-2 py-5">
               ...
               <input type="text" placeholder="Enter Gmail" className="block border-2 border-black w-60 h-8 placeholder:p-2 py-2 font-semibold text-xl "></input>
               </div>
                 <div className="md:mt-8">
                   <button className="px-3 py-2 bg-red-500 text-white font-bold rounded-lg hover:bg-black ">Submit Now</button>
                 </div>
               </div>
           </div>
           <div>
              <img src="/Assets/head5.jpg" alt="" className="lg:w-[60rem] rounded-xl"></img>
           </div>
        </div>
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center gap-16 ">
           <div className="text-center border p-5 rounded-xl shadow-lg space-y-2 md:w-80 ">
             ...
             <h3 className="font-semibold">And free returns. See checkout for delivery dates.</h3>
           </div>
           <div className="text-center border p-5 rounded-xl shadow-lg space-y-2 md:w-80 ">
              <div className="flex justify-center">
