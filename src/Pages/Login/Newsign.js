...
function Newsign() {
  ...
  const handleRegister = async () => {
    try {
      ...
      if (error.code === "auth/email-already-in-use") errorMessage = "This email is already in use. Please try logging in.";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-indigo-600 px-4">
      ...
      <form className="bg-white p-6 md:p-8 rounded-2xl shadow-xl w-full max-w-md space-y-5" onSubmit={handleSubmit}>
